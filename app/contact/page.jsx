                ...
                <div className="flex flex-col xl:flex-row gap-[30px]">
                    <div className="xl:w-[54%] order-2 xl:order-none">
                        ...
                        <form className="flex flex-col gap-6 p-10 bg-[#27272c] rounded-xl">
                            ...
                            <p className="text-white/60">Please enter your contact information below!</p>
                            ...
                            <Select>
                                ...
                                <SelectContent>
                                    <SelectGroup>
                                        ...
                                        <SelectItem value="cst">Portfolio Development</SelectItem>
                            ...
                            {/* submit button */}
                            <Button size="md" className="text-white/80 bg-primary max-w-40">
                                Submit
                            </Button>
